...
Report_SummaryLog "    MAC   -  FM Verison check -   PING Results -    Braodcast Check  -etho -eth1-wlan1  "
...
Report_SummaryLog "    MAC   -  FM Verison check -   PING Results -    Braodcast Check -etho -eth1- wlan   "
